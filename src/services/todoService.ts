...
import type { ErrorResponse } from "../../worker/db/schema";
...
export type UserTodosGetQueryParams = Parameters<typeof client.api.users[':userId']['todos']['$get']>[0]['query'];
...
export const isApiError = (error: unknown): error is TodoApiError => {
  return error instanceof TodoApiError;
};
